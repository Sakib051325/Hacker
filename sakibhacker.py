...
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mUPDATE VERSHON 1.2V...! ')
os.system("espeak -a 300 \"UPDATE VERSION 1.2V,\"")
time.sleep(2)
#os.system('clear')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/Sakib051325/Aprbol-new/blob/main/Aprbol-new').text
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Sakib051325/Aprbol-new/blob/main/Aprbol-new')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
